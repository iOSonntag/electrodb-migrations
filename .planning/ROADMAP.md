...
- [ ] **Phase 4: Apply, Release & Finalize Runner** - Happy-path runner: scan v1 records, run `up()`, write v2, transition to release-mode, multi-migration handoff, finalize under maintenance-mode lock; CLI commands `apply`/`release`/`finalize`/`status`/`history` plus blocking programmatic client
...
|-------|----------------|--------|-----------|
| 1. Foundation & Safety Primitives | 0/9 | Not started | - |
| 2. Drift Detection & Authoring Loop | 0/9 | Not started | - |
| 3. Internal Entities, Lock & Guard | 0/8 | Not started | - |
| 4. Apply, Release & Finalize Runner | 0/TBD | Not started | - |
