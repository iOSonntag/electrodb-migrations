 ...
 * - `dying` — the runner has detected a fatal local failure but has not
 *   yet completed `markFailed`; admitted to the stale-takeover state filter
 *   so a stuck `dying` row can be reclaimed.
